---
title: "Breaking Down the Substation: Four Vulnerabilities in Siemens SICAM S8000 (SSA-229470)"
date: 2026-07-09
draft: true
summary: "Four coordinated-disclosure vulnerabilities in Siemens SICAM S8000 — RBAC bypass, a firmware signature bypass, insecure OPC UA defaults, and a debug-interface DoS — fixed in V26.20 and published as SSA-229470."
vendor: "Siemens"
product: "SICAM S8000 / SICAM 8"
advisoryUrl: "https://cert-portal.siemens.com/productcert/html/ssa-229470.html"
caseId: "S-PCERT#42306"
status: "fixed"
reportedDate: 2026-04-18
disclosedDate: 2026-07-09
cves:
  - id: "CVE-2026-54801"
    title: "Authentication bypass / privilege escalation in the SICAM WEB management API"
    cvss3: 7.2
    cvss4: 8.6
    cwe: "CWE-269"
  - id: "CVE-2026-54799"
    title: "Firmware-update signature validation can be disabled by an active debug command"
    cvss3: 6.7
    cvss4: 8.4
    cwe: "CWE-489"
  - id: "CVE-2026-54800"
    title: "OPC UA server ships with all security mechanisms disabled by default"
    cvss3: 4.8
    cvss4: 6.3
    cwe: "CWE-1188"
  - id: "CVE-2026-54798"
    title: "Debug interface reachable over HTTP crashes the web process (DoS)"
    cvss3: 6.5
    cvss4: 7.1
    cwe: "CWE-489"
tags: ["ics", "ot", "vulnerability-disclosure", "siemens"]
---

Over a research engagement against Siemens' **SICAM S8000 V26.10** power-automation platform, North Echo reported a set of authenticated and unauthenticated security issues to Siemens ProductCERT. Siemens fixed them in **V26.20** and published **SSA-229470** with four CVEs, summarized above.
...
| Apr 20 | Siemens opens case **S-PCERT#42306** |
...
These findings were reported to and fixed by **Siemens ProductCERT** under coordinated disclosure (case **S-PCERT#42306**). Thanks to the ProductCERT team for professional handling and a timely fix. Full CVE details are in the Siemens advisory.
